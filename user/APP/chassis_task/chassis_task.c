...
static void chassis_init(chassis_move_t *chassis_move_init)
{
    ...
    //获取遥控器指针
	// get the remote control pointer
...
static void chassis_control_loop(chassis_move_t *chassis_move_control_loop)
{
    ...
    for (i = 0; i < 4; i++)
    {
		...
		*/
		...
		chassis_move_control_loop->motor_chassis[0].give_current = (int16_t)(chassis_move_control_loop->motor_speed_pid[0].out);
		chassis_move_control_loop->motor_chassis[1].give_current = (int16_t)(chassis_move_control_loop->motor_speed_pid[1].out);
		chassis_move_control_loop->motor_chassis[2].give_current = (int16_t)(chassis_move_control_loop->motor_speed_pid[2].out);
		chassis_move_control_loop->motor_chassis[3].give_current = (int16_t)(chassis_move_control_loop->motor_speed_pid[3].out);
}
